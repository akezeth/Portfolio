...
const topProjectObj = {
  title: "The Big 5 Construct Ethiopia 2023",
  description:
    "HTML-CSS-JavaScript Capstone Project is my first Microverse capstone project. I created it using HTML, CSS and JavaScript. It is an online website for a Construction confrence.",
...
const modalProjects = [
  {
    title: "The Big 5 Construct Ethiopia 2023",
    description: `HTML-CSS-JavaScript Capstone Project is my first Microverse capstone project. I created it using HTML, CSS and JavaScript. It is an online website for a Construction confrence.
    
    Addisbuild by Big 5 Construct Ethiopia is the longest-running building and construction exhibition in Ethiopia. Acquired by dmg events in 2020, it brings together influential decision-makers from the region and beyond at the Millennium Hall in Addis Ababa. The event is officially supported by the Ethiopian Ministry of Urban Development and Construction and its Minister, Eng. Aisha Mohammed Mussa.`,
    image: "./images/1-image.png",
    technologies: ["CSS", "HTML", "JavaScript"],
    liveLink: "https://akezeth.github.io/HTML-CSS-JavaScript-Capstone-Project/",
    sourceLink:
      "https://github.com/akezeth/HTML-CSS-JavaScript-Capstone-Project",
  },
  {
    title: "Profesional Art Printing Data",
